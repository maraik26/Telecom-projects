...
df1 = spark.sql('create table arstel.mb_pir_full as \
                 select distinct r.subs_key, r.CALLED_NUM from \ 
                 (select CALLED_NUM, SUBS_KEY, CALL_START_TIME from BIIS_FCT.FCT_USAGE_PREP_CHA_N where \
                 (CALL_START_TIME>='P20190101' and CALL_START_TIME<='P20190130' and CALL_TYPE_CODE='V' and \
